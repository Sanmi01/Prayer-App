  ...
  return (
    ...
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 lg:grid lg:grid-cols-2 sm:py-16 lg:px-6">
        <div class="my-4 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-semibold text-gray-900 dark:text-white">Not Just A Tool.</h2>
            <p class="mb-6 text-lg">The God Listens Prayer App isn't just a tool; it's your gateway to unparalleled digital engagement. Dive into the digital age and witness the transformative power of active prayer engagement.</p>
        ...
        <img class="w-full dark:hidden" src={PrayerHands} alt="Prayer Hands" />
    </div>
</section>
    </>
  )
