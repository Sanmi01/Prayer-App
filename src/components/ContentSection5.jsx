  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="text-gray-500 sm:text-lg dark:text-gray-400 flex flex-col justify-center items-center text-center gap-8 ">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0">
            <a href="/" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 bg-white uppercase">
                Open in a new tab
            </a> 
        </div>
